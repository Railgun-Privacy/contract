...
async function main() {
  ...
  await run('verify:verify', {
    ...
    contract: 'contracts/token/RailTokenDAOMintable.sol:RailTokenDAOMintable',
  });

  await run('verify:verify', {
    address: staking.address,
    constructorArguments: [rail.address],
  });
  ...
  await run('verify:verify', {
    ...
    constructorArguments: [staking.address, delegator.address],
  });

  await run('verify:verify', {
    address: treasury.address,
    constructorArguments: [delegator.address],
  });
